                        ...
                        <section>
                            ...
                            <section class="login-verification">
                                ...
                                <div class="switch-show">
                                    <img @click.prevent="dealPwdMode(false)"
                                         :class="{on: pwdMode}"
                                         src="./images/hide_pwd.png"
                                         alt=""
                                         width="20">
                                    <img @click.prevent="dealPwdMode(true)"
                                         :class="{on: !pwdMode}"
                            ...
                            <section class="login-message">
                                ...
                                <img ref="captcha"
                                     class="get-verification"
                                     src="http://localhost:55000/api/captcha"
                                     alt="captcha"
...
export default {
    ...
    methods: {
        ...
        // 4. 获取图形验证码
        getCaptcha () {
            this.$refs.captcha.src = 'http://localhost:55000/api/captcha?time=' + new Date();
        },
        // 5. 登录
        async login () {
            // 5.1 登录模式
